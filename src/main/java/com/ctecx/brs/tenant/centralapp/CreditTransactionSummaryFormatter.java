// src/main/java/com/ctecx/brs/tenant/centralapp/CreditTransactionSummaryFormatter.java
...
public class CreditTransactionSummaryFormatter {

    private final ObjectMapper objectMapper;

    /**
     * Parses the raw data list from the GetCreditTransactionSummary stored procedure.
     ...
     * @return A List of Maps representing the fully parsed credit transactions.
     */
