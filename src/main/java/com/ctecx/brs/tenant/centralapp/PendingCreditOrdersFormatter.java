// src/main/java/com/ctecx/brs/tenant/centralapp/PendingCreditOrdersFormatter.java
...
public class PendingCreditOrdersFormatter {

    private final ObjectMapper objectMapper;

    /**
     * Parses the raw data from the GetPendingCreditOrders stored procedure.
     */
